...
import { useGlobals, FishParameters } from "../hooks";
...
export const ThemePicker = () => {
  ...
  const fluentTheme: FishParameters["fluentTheme"] =
    useParameter("fluentTheme");

  const selectedThemeId = fluentTheme
    ? fluentTheme
    : (globals[THEME_ID] ?? defaultTheme.id);
  ...
  return (
    <>
      ...
      >
        <IconButton key={THEME_ID} title="Change Fish theme" active={isActive}>
