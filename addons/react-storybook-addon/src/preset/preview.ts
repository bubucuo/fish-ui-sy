...
import { withFishProvider } from "../decorators/withFishProvider";
import { withReactStrictMode } from "../decorators/withReactStrictMode";
import { withAriaLive } from "../decorators/withAriaLive";
import { THEME_ID } from "../src/constants";

export const decorators = [withFishProvider, withAriaLive, withReactStrictMode];
