import {
  useGlobals as useStorybookGlobals,
  Args as StorybookArgs,
} from "@storybook/api";
import {
...
export interface FishStoryContext extends StorybookContext {
  globals: FishGlobals;
 ...
 */
export interface FishGlobals extends StorybookArgs {
  [DIR_ID]?: "ltr" | "rtl";
  [THEME_ID]?: ThemeIds;
 ...
 */
export interface FishParameters extends Parameters {
  dir?: "ltr" | "rtl";
  fluentTheme?: ThemeIds;
  mode?: "default" | "vr-test";
}

export function useGlobals(): [FishGlobals, (newGlobals: FishGlobals) => void] {
  return useStorybookGlobals();
}

export function parameters(options?: FishParameters) {
