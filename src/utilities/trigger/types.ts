 ...
 * ```ts
 * const MyComponent: React.FC<MyComponentProps> & FishTriggerComponent = ...;
 *
 * MyComponent.isFishTriggerComponent = true; // MUST also set this to true
 * ```
 */
export type FishTriggerComponent = {
  isFishTriggerComponent?: boolean;
};
