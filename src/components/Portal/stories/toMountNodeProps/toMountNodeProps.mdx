...
import * as Index from './index.stories.tsx';

{/* 这里也命名为Docs */}
<Meta of={Index} name="Docs" />

# toMountNodeProps

Fish UI uses a wrapper component called `Portal` to render portals using [`ReactDOM.createPortal()`](https://react.dev/reference/react-dom/createPortal).
...
```tsx
import { toMountNodeProps } from 'fish-ui-sy';
